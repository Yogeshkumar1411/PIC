...
__pidataBANK0:
	file	"D:\Embedded\pic\code\Indu886.c"
	line	23
...
;; *************** function _main *****************
;; Defined at:
;;		line 266 in file "D:\Embedded\pic\code\Indu886.c"
...
l3907:	
;Indu886.c: 267: int Pre_a1,Pre_b1,Pre_c1,Pre_d1,Pre_e1,Pre_f1;
;Indu886.c: 268: TRISC=0X98;
	movlw	(098h)
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
l3911:	
;Indu886.c: 270: TRISA=0X3F;
	movlw	(03Fh)
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	movwf	(133)^080h	;volatile
	line	271
;Indu886.c: 271: PORTA=0X00;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	clrf	(5)	;volatile
	line	272
...
l3915:	
;Indu886.c: 273: PORTB=0X00;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	clrf	(6)	;volatile
	line	274
;Indu886.c: 274: ANSEL=0X10;
	movlw	(010h)
...
l3929:	
;Indu886.c: 281: lcd_cmd(0,0,0X28);
	movlw	low(0)
	movwf	(?_lcd_cmd)
	movlw	high(0)
	movwf	((?_lcd_cmd))+1
...
l3931:	
;Indu886.c: 282: lcd_cmd(0,0,0X02);
	movlw	low(0)
	movwf	(?_lcd_cmd)
	movlw	high(0)
	movwf	((?_lcd_cmd))+1
...
l3933:	
;Indu886.c: 283: lcd_cmd(0,0,0X0E);
	movlw	low(0)
	movwf	(?_lcd_cmd)
	movlw	high(0)
	movwf	((?_lcd_cmd))+1
...
l3935:	
;Indu886.c: 286: retain=eeprom_read(0);
	movlw	(0)
	fcall	_eeprom_read
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
...
l3939:	
;Indu886.c: 290: if(RA1==1&&flag_supply==1)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	btfss	(41/8),(41)&7
	goto	u4001
...
l3945:	
;Indu886.c: 293: Pre_a1=retain/1000;
	movlw	low(03E8h)
	movwf	(?___awdiv)
	movlw	high(03E8h)
	movwf	((?___awdiv))+1
...
l3947:	
;Indu886.c: 294: Pre_b1=retain%1000;
	movlw	low(03E8h)
	movwf	(?___awmod)
	movlw	high(03E8h)
	movwf	((?___awmod))+1
...
l3949:	
;Indu886.c: 295: Pre_c1=Pre_b1/100;
	movlw	low(064h)
	movwf	(?___awdiv)
	movlw	high(064h)
	movwf	((?___awdiv))+1
...
l3951:	
;Indu886.c: 296: Pre_d1=Pre_b1%100;
	movlw	low(064h)
	movwf	(?___awmod)
	movlw	high(064h)
	movwf	((?___awmod))+1
...
l3953:	
;Indu886.c: 297: Pre_e1=Pre_d1/10;
	movlw	low(0Ah)
	movwf	(?___awdiv)
	movlw	high(0Ah)
	movwf	((?___awdiv))+1
...
l3955:	
;Indu886.c: 298: Pre_f1=Pre_d1%10;
	movlw	low(0Ah)
	movwf	(?___awmod)
	movlw	high(0Ah)
	movwf	((?___awmod))+1
...
l3957:	
;Indu886.c: 300: lcd_cmd(0,0,0X01);
	movlw	low(0)
	movwf	(?_lcd_cmd)
	movlw	high(0)
	movwf	((?_lcd_cmd))+1
...
l3959:	
;Indu886.c: 301: lcd_cmd(0,0,0X80);
	movlw	low(0)
	movwf	(?_lcd_cmd)
	movlw	high(0)
	movwf	((?_lcd_cmd))+1
...
l3961:	
;Indu886.c: 302: string(" Generator On");
...
l3963:	
;Indu886.c: 303: lcd_cmd(0,0,0X91);
	movlw	low(0)
	movwf	(?_lcd_cmd)
	movlw	high(0)
	movwf	((?_lcd_cmd))+1
...
l3965:	
;Indu886.c: 304: string(" Previous_run:");
...
l3967:	
;Indu886.c: 305: lcd_cmd(0,0,0XD0);
	movlw	low(0)
	movwf	(?_lcd_cmd)
	movlw	high(0)
	movwf	((?_lcd_cmd))+1
...
l3969:	
;Indu886.c: 306: lcd_cmd(1,0,Pre_a1+0X30);
	movlw	low(01h)
	movwf	(?_lcd_cmd)
	movlw	high(01h)
	movwf	((?_lcd_cmd))+1
...
l3971:	
;Indu886.c: 307: lcd_cmd(1,0,Pre_c1+0X30);
	movlw	low(01h)
	movwf	(?_lcd_cmd)
	movlw	high(01h)
	movwf	((?_lcd_cmd))+1
...
l3973:	
;Indu886.c: 308: lcd_cmd(1,0,Pre_e1+0X30);
	movlw	low(01h)
	movwf	(?_lcd_cmd)
	movlw	high(01h)
	movwf	((?_lcd_cmd))+1
...
l3975:	
;Indu886.c: 309: lcd_cmd(1,0,Pre_f1+0X30);
	movlw	low(01h)
	movwf	(?_lcd_cmd)
	movlw	high(01h)
	movwf	((?_lcd_cmd))+1
...
l3983:	
;Indu886.c: 313: delay(60000);delay(60000);delay(60000);delay(60000);delay(60000);delay(60000);
	movlw	low(0EA60h)
	movwf	(?_delay)
	movlw	high(0EA60h)
	movwf	((?_delay))+1
...
l3999:	
;Indu886.c: 316: }
;Indu886.c: 317: I2C_Start();
	fcall	_I2C_Start
	line	318
	
l4001:	
;Indu886.c: 318: I2C_Slave(0XD0);
	movlw	(0D0h)
	fcall	_I2C_Slave
	line	319
	
l4003:	
;Indu886.c: 319: I2C_Slave(0X00);
	movlw	(0)
	fcall	_I2C_Slave
	line	320
	
l4005:	
;Indu886.c: 320: I2C_Restart();
	fcall	_I2C_Restart
	line	321
	
l4007:	
;Indu886.c: 321: I2C_Slave(0XD1);
	movlw	(0D1h)
	fcall	_I2C_Slave
	line	322
	
l4009:	
;Indu886.c: 322: for(i=0;i<3;i++)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	clrf	(_i)
...
l4015:	
;Indu886.c: 325: read[i]=I2C_Read(i);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_i),w
	movwf	(??_main+0)+0
...
l4021:	
;Indu886.c: 326: }
;Indu886.c: 327: I2C_Stop();
	fcall	_I2C_Stop
	line	328
	
l4023:	
;Indu886.c: 328: conversion(read);
	movlw	(_read)&0ffh
	fcall	_conversion
	line	329
	
l4025:	
;Indu886.c: 329: delay(1000);
	movlw	low(03E8h)
	movwf	(?_delay)
	movlw	high(03E8h)
	movwf	((?_delay))+1
...
l4027:	
;Indu886.c: 330: Gate_Siren(read);
	movlw	(_read)&0ffh
	fcall	_Gate_Siren
	line	331
	
l4029:	
;Indu886.c: 331: Generator_run();
	fcall	_Generator_run
	line	332
	
l4031:	
;Indu886.c: 332: if(RA2==1&&flag1==0&&flag2==0)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	btfss	(42/8),(42)&7
	goto	u4041
...
l4041:	
;Indu886.c: 336: }
;Indu886.c: 337: if(RA3==1&&flag1==1)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	btfss	(43/8),(43)&7
	goto	u4071
...
l4051:	
;Indu886.c: 343: {
;Indu886.c: 344: flag1=0;
	clrf	(_flag1)
	clrf	(_flag1+1)
	line	345
;Indu886.c: 345: flag2=0;
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	clrf	(_flag2)^080h
	clrf	(_flag2+1)^080h
...
;; *************** function _adc *****************
;; Defined at:
;;		line 205 in file "D:\Embedded\pic\code\Indu886.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
...
l3801:	
;Indu886.c: 206: auto int vari1;
;Indu886.c: 207: auto float temp;
;Indu886.c: 208: auto int high,low,sensorvalue;
;Indu886.c: 209: auto int temp_a,temp_b,temp_c,temp_d,temp_e,temp_f;
;Indu886.c: 211: int u;
;Indu886.c: 212: if(u==0)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	((adc@u+1)),w
	iorwf	((adc@u)),w
...
l3803:	
;Indu886.c: 213: {
;Indu886.c: 214: lcd_cmd(0,0,0X90);
	movlw	low(0)
	movwf	(?_lcd_cmd)
	movlw	high(0)
	movwf	((?_lcd_cmd))+1
...
l3823:	
;Indu886.c: 225: sensorvalue=low+(high*256);
	movf	(adc@high+1),w
	movwf	(??_adc+0)+0+1
	movf	(adc@high),w
	movwf	(??_adc+0)+0
...
l3825:	
;Indu886.c: 226: if(sensorvalue>=680)
...
l3829:	
;Indu886.c: 229: int Final_value;
;Indu886.c: 230: vari1=sensorvalue-680;
...
l3831:	
;Indu886.c: 231: temp=(vari1*0.2840);
	movlw	0x68
	movwf	(?___ftmul)
	movlw	0x91
	movwf	(?___ftmul+1)
...
l3833:	
;Indu886.c: 232: Final_value=temp*10;
	movf	(adc@temp),w
	movwf	0+(?___ftmul)+03h
	movf	(adc@temp+1),w
	movwf	1+(?___ftmul)+03h
...
l3835:	
;Indu886.c: 234: temp_a=Final_value/1000;
	movlw	low(03E8h)
	movwf	(?___awdiv)
	movlw	high(03E8h)
	movwf	((?___awdiv))+1
...
l3837:	
;Indu886.c: 235: temp_b=Final_value%1000;
	movlw	low(03E8h)
	movwf	(?___awmod)
	movlw	high(03E8h)
	movwf	((?___awmod))+1
...
l3839:	
;Indu886.c: 236: temp_c=temp_b/100;
	movlw	low(064h)
	movwf	(?___awdiv)
	movlw	high(064h)
	movwf	((?___awdiv))+1
...
l3841:	
;Indu886.c: 237: temp_d=temp_b%100;
	movlw	low(064h)
	movwf	(?___awmod)
	movlw	high(064h)
	movwf	((?___awmod))+1
...
l3843:	
;Indu886.c: 238: temp_e=temp_d/10;
	movlw	low(0Ah)
	movwf	(?___awdiv)
	movlw	high(0Ah)
	movwf	((?___awdiv))+1
...
l3845:	
;Indu886.c: 239: temp_f=temp_d%10;
	movlw	low(0Ah)
	movwf	(?___awmod)
	movlw	high(0Ah)
	movwf	((?___awmod))+1
...
l3847:	
;Indu886.c: 240: lcd_cmd(0,0,0X90);
	movlw	low(0)
	movwf	(?_lcd_cmd)
	movlw	high(0)
	movwf	((?_lcd_cmd))+1
...
l3851:	
;Indu886.c: 242: lcd_cmd(1,0,0X30+temp_a);
	movlw	low(01h)
	movwf	(?_lcd_cmd)
	movlw	high(01h)
	movwf	((?_lcd_cmd))+1
...
l3853:	
;Indu886.c: 243: lcd_cmd(1,0,0X30+temp_c);
	movlw	low(01h)
	movwf	(?_lcd_cmd)
	movlw	high(01h)
	movwf	((?_lcd_cmd))+1
...
l3855:	
;Indu886.c: 244: lcd_cmd(1,0,0X30+temp_e);
	movlw	low(01h)
	movwf	(?_lcd_cmd)
	movlw	high(01h)
	movwf	((?_lcd_cmd))+1
...
l3857:	
;Indu886.c: 245: lcd_cmd(1,0,0X30+temp_f);
	movlw	low(01h)
	movwf	(?_lcd_cmd)
	movlw	high(01h)
	movwf	((?_lcd_cmd))+1
...
l3859:	
;Indu886.c: 247: if(Final_value>=260)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(adc@Final_value+1),w
	xorlw	80h
...
l3867:	
;Indu886.c: 252: delay(60000);delay(60000);delay(60000);delay(60000);delay(60000);delay(60000);
	movlw	low(0EA60h)
	movwf	(?_delay)
	movlw	high(0EA60h)
	movwf	((?_delay))+1
...
l3879:	
;Indu886.c: 253: delay(60000);delay(60000);delay(60000);delay(60000);delay(60000);delay(60000);
	movlw	low(0EA60h)
	movwf	(?_delay)
	movlw	high(0EA60h)
	movwf	((?_delay))+1
...
l3891:	
;Indu886.c: 254: delay(60000);delay(60000);delay(60000);delay(60000);delay(60000);delay(60000);
	movlw	low(0EA60h)
	movwf	(?_delay)
	movlw	high(0EA60h)
	movwf	((?_delay))+1
...
;; Defined at:
;;		line 112 in file "D:\Embedded\pic\code\Indu886.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
...
l3723:	
;Indu886.c: 113: auto int Gen_a,Gen_b,Gen_c,Gen_d,Gen_e,Gen_f;
;Indu886.c: 114: lcd_cmd(0,0,0XC0);
	movlw	low(0)
	movwf	(?_lcd_cmd)
	movlw	high(0)
	movwf	((?_lcd_cmd))+1
...
l3727:	
;Indu886.c: 116: Gen_a=variable/1000;
	movlw	low(03E8h)
	movwf	(?___awdiv)
	movlw	high(03E8h)
	movwf	((?___awdiv))+1
...
l3729:	
;Indu886.c: 117: Gen_b=variable%1000;
	movlw	low(03E8h)
	movwf	(?___awmod)
	movlw	high(03E8h)
	movwf	((?___awmod))+1
...
l3739:	
;Indu886.c: 122: lcd_cmd(1,0,Gen_a+0X30);
	movlw	low(01h)
	movwf	(?_lcd_cmd)
	movlw	high(01h)
	movwf	((?_lcd_cmd))+1
...
l3741:	
;Indu886.c: 123: lcd_cmd(1,0,Gen_c+0X30);
	movlw	low(01h)
	movwf	(?_lcd_cmd)
	movlw	high(01h)
	movwf	((?_lcd_cmd))+1
...
l3743:	
;Indu886.c: 124: lcd_cmd(1,0,Gen_e+0X30);
	movlw	low(01h)
	movwf	(?_lcd_cmd)
	movlw	high(01h)
	movwf	((?_lcd_cmd))+1
...
l3745:	
;Indu886.c: 125: lcd_cmd(1,0,Gen_f+0X30);
	movlw	low(01h)
	movwf	(?_lcd_cmd)
	movlw	high(01h)
	movwf	((?_lcd_cmd))+1
...
l3749:	
;Indu886.c: 127: if(RA0==1&&flag_supply==0)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	btfss	(40/8),(40)&7
	goto	u3931
...
l3759:	
;Indu886.c: 132: lcd_cmd(0,0,0X01);
	movlw	low(0)
	movwf	(?_lcd_cmd)
	movlw	high(0)
	movwf	((?_lcd_cmd))+1
...
l3761:	
;Indu886.c: 133: lcd_cmd(0,0,0X80);
	movlw	low(0)
	movwf	(?_lcd_cmd)
	movlw	high(0)
	movwf	((?_lcd_cmd))+1
...
l3763:	
;Indu886.c: 134: string(" From EB supply");
...
l3765:	
;Indu886.c: 135: delay(60000);delay(60000);delay(60000);delay(60000);delay(60000);delay(60000);
	movlw	low(0EA60h)
	movwf	(?_delay)
	movlw	high(0EA60h)
	movwf	((?_delay))+1
...
l3779:	
;Indu886.c: 137: }
;Indu886.c: 138: if(Generator==1&&read[0]==stop)
	movlw	01h
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
l3785:	
;Indu886.c: 142: delay(60000);delay(60000);delay(60000);delay(60000);delay(60000);delay(60000);
	movlw	low(0EA60h)
	movwf	(?_delay)
	movlw	high(0EA60h)
	movwf	((?_delay))+1
...
l3797:	
;Indu886.c: 143: }
;Indu886.c: 144: store=retain+variable;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_variable),w
	addwf	(_retain),w
...
l3799:	
;Indu886.c: 145: eeprom_write(0,store);
	movf	(_store)^080h,w
	movwf	(??_Generator_run+0)+0
	movf	(??_Generator_run+0)+0,w
	movwf	(?_eeprom_write)
...
;; Defined at:
;;		line 84 in file "D:\Embedded\pic\code\Indu886.c"
;; Parameters:    Size  Location     Type
...
l3707:	
;Indu886.c: 87: lcd_cmd(1,0,((disp[2]&0X30)>>4)+0X30);
	movlw	low(01h)
	movwf	(?_lcd_cmd)
	movlw	high(01h)
	movwf	((?_lcd_cmd))+1
...
l3709:	
;Indu886.c: 88: lcd_cmd(1,0,(disp[2]&0X0F)+0X30);
	movlw	low(01h)
	movwf	(?_lcd_cmd)
	movlw	high(01h)
	movwf	((?_lcd_cmd))+1
...
l3713:	
;Indu886.c: 91: lcd_cmd(1,0,((disp[1]&0X70)>>4)+0X30);
	movlw	low(01h)
	movwf	(?_lcd_cmd)
	movlw	high(01h)
	movwf	((?_lcd_cmd))+1
...
l3715:	
;Indu886.c: 92: lcd_cmd(1,0,(disp[1]&0X0F)+0X30);
	movlw	low(01h)
	movwf	(?_lcd_cmd)
	movlw	high(01h)
	movwf	((?_lcd_cmd))+1
...
l3719:	
;Indu886.c: 95: lcd_cmd(1,0,((disp[0]&0X70)>>4)+0X30);
	movlw	low(01h)
	movwf	(?_lcd_cmd)
	movlw	high(01h)
	movwf	((?_lcd_cmd))+1
...
l3721:	
;Indu886.c: 96: lcd_cmd(1,0,(disp[0]&0X0F)+0X30);
	movlw	low(01h)
	movwf	(?_lcd_cmd)
	movlw	high(01h)
	movwf	((?_lcd_cmd))+1
...
;; *************** function _gsm *****************
;; Defined at:
;;		line 172 in file "D:\Embedded\pic\code\Indu886.c"
;; Parameters:    Size  Location     Type
;;  cmd             2    4[COMMON] int 
;; Auto vars:     Size  Location     Type
;;		None
...
;Indu886.c: 180: delay(10000);
	...
	fcall	_delay
	line	181
;Indu886.c: 181: trans("AT+CMGS=\"+919566511486\"");
...
l3681:	
;Indu886.c: 185: {
;Indu886.c: 186: trans("This an emergency due to Generator overheat. Take an action.");
...
l3685:	
;Indu886.c: 189: {
;Indu886.c: 190: trans("Generator diesel reached low level 1 liter");
...
l3689:	
;Indu886.c: 193: {
;Indu886.c: 194: trans("Generator diesel reached very low level 0.5 liter");
...
;; *************** function _string *****************
;; Defined at:
;;		line 76 in file "D:\Embedded\pic\code\Indu886.c"
;; Parameters:    Size  Location     Type
...
;; *************** function _new *****************
;; Defined at:
;;		line 167 in file "D:\Embedded\pic\code\Indu886.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l3653:	
;Indu886.c: 168: tran(0X0D);
	movlw	(0Dh)
	fcall	_tran
	line	169
;Indu886.c: 169: tran(0X0A);
	movlw	(0Ah)
	fcall	_tran
	line	170
...
;; *************** function _lcd_cmd *****************
;; Defined at:
;;		line 17 in file "D:\Embedded\pic\code\lcd.h"
;; Parameters:    Size  Location     Type
;;  a               2    2[COMMON] int 
;;  b               2    4[COMMON] int 
...
;;
psect	text605
	file	"D:\Embedded\pic\code\lcd.h"
	line	17
...
;; *************** function _tran *****************
;; Defined at:
;;		line 160 in file "D:\Embedded\pic\code\Indu886.c"
;; Parameters:    Size  Location     Type
...
l3581:	
;Indu886.c: 161: TXREG=data2;
	movf	(tran@data2),w
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(25)	;volatile
	line	162
;Indu886.c: 162: while(TXIF==0);
	goto	l1065
...
l1067:	
	line	163
;Indu886.c: 163: TXIF=0;
	bcf	(100/8),(100)&7
	line	164
	
l3583:	
;Indu886.c: 164: delay(1000);
	movlw	low(03E8h)
	movwf	(?_delay)
	movlw	high(03E8h)
	movwf	((?_delay))+1
...
;; *************** function _trans *****************
;; Defined at:
;;		line 150 in file "D:\Embedded\pic\code\Indu886.c"
;; Parameters:    Size  Location     Type
...
l1060:	
	line	155
;Indu886.c: 155: TXIF=0;
	bcf	(100/8),(100)&7
	line	156
	
l3577:	
;Indu886.c: 156: delay(1000);
	movlw	low(03E8h)
	movwf	(?_delay)
	movlw	high(03E8h)
	movwf	((?_delay))+1
...
;; Defined at:
;;		line 101 in file "D:\Embedded\pic\code\Indu886.c"
;; Parameters:    Size  Location     Type
...
l3549:	
;Indu886.c: 103: if((read1[2]==0X10&&read1[1]==0X00&&read1[0]==0X00)||(read1[2]==0X01&&read1[1]==0X00&&read1[0]==0X00)||(read1[2]==0X05&&read1[1]==0X00&&read1[0]==0X00))
...
l3567:	
;Indu886.c: 106: delay(60000);delay(60000);delay(60000);delay(60000);delay(60000);
	movlw	low(0EA60h)
	movwf	(?_delay)
	movlw	high(0EA60h)
	movwf	((?_delay))+1
...
;; Defined at:
;;		line 53 in file "D:\Embedded\pic\code\Indu886.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _I2C_Slave *****************
;; Defined at:
;;		line 46 in file "D:\Embedded\pic\code\Indu886.c"
;; Parameters:    Size  Location     Type
...
l3541:	
;Indu886.c: 48: SSPBUF=data;
	movf	(I2C_Slave@data),w
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(19)	;volatile
	line	49
;Indu886.c: 49: while(ACKSTAT==1);
	goto	l1015
...
;; *************** function _I2C_Stop *****************
;; Defined at:
;;		line 41 in file "D:\Embedded\pic\code\Indu886.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _I2C_Start *****************
;; Defined at:
;;		line 36 in file "D:\Embedded\pic\code\Indu886.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _pulse *****************
;; Defined at:
;;		line 10 in file "D:\Embedded\pic\code\lcd.h"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _I2C_Read *****************
;; Defined at:
;;		line 58 in file "D:\Embedded\pic\code\Indu886.c"
;; Parameters:    Size  Location     Type
...
l3167:	
;Indu886.c: 59: unsigned char read1;
;Indu886.c: 60: if(i==2)
	movlw	02h
	xorwf	(I2C_Read@i),w
...
l3173:	
;Indu886.c: 70: SSPOV=0;
	bcf	(166/8),(166)&7
	line	71
	
l3175:	
;Indu886.c: 71: ACKEN=1;
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
;; *************** function _hold *****************
;; Defined at:
;;		line 31 in file "D:\Embedded\pic\code\Indu886.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _delay *****************
;; Defined at:
;;		line 6 in file "D:\Embedded\pic\code\lcd.h"
;; Parameters:    Size  Location     Type
