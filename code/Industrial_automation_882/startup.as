	...
	; Compiler options:
	;
	; -oIndustrial_automation.cof -mIndustrial_automation.map \
	; --summary=default --output=default Industrial_automation.p1 \
	; --chip=16F882 -P --runtime=default --opt=default -D__DEBUG=1 -g \
