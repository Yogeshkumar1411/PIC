...
;; *************** function _main *****************
;; Defined at:
;;		line 9 in file "D:\Embedded\pic\code\software\led\password1\password.c"
...
;;
psect	maintext
	file	"D:\Embedded\pic\code\software\led\password1\password.c"
	line	9
...
;password.c: 10: int count=0;
	...
	clrf	(main@count+1)
	line	11
;password.c: 11: PORTA=0X00;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	clrf	(5)	;volatile
	line	12
;password.c: 12: TRISA=0X00;
...
l1030:	
	line	29
;password.c: 28: }
;password.c: 29: if((RC1==1)&&(count==2))
	btfss	(57/8),(57)&7
	goto	u71
	goto	u70
u71:
...
l1034:	
	line	34
;password.c: 33: }
;password.c: 34: if((RC3==1)&&(count==3))
	btfss	(59/8),(59)&7
	goto	u101
	goto	u100
u101:
...
l1038:	
	line	39
;password.c: 38: }
;password.c: 39: if((RC4==1)&&(count==4))
	btfss	(60/8),(60)&7
	goto	u131
	goto	u130
u131:
